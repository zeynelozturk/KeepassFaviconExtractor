...
- User prefers minimal behavioral changes to existing flow and wants extract-related errors and results shown in the live status window instead of popup dialogs, and prefers fixes that avoid touching unrelated implementations.
